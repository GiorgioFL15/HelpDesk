...
public class MenuChamado {
	...
	private void consultarChamadosFechados(UsuarioVO usuarioVO) {
		...
		chamadoVO = chamadoController.buscarChamadosController(usuarioVO, 2);
		System.out.println("\n================== Chamados ==================");
		if (chamadoVO != null) {
			for (int c = 0; c < chamadoVO.size(); c++) {
				System.out.println(chamadoVO.get(c).toString());
			}
		} else {
	...
	private void consultarChamadosAbertos(UsuarioVO usuarioVO) {
		ChamadoController chamadoController = new ChamadoController();
		ArrayList<ChamadoVO> chamadoVO = new ArrayList<ChamadoVO>();
		chamadoVO = chamadoController.buscarChamadosController(usuarioVO, 1);
		System.out.println("\n================== Chamados ==================");
		if (chamadoVO != null) {
			for (int c = 0; c < chamadoVO.size(); c++) {
				System.out.println(chamadoVO.get(c).toString());
	...
	private void consultarTodos(UsuarioVO usuarioVO) {
		ChamadoController chamadoController = new ChamadoController();
		ArrayList<ChamadoVO> chamadoVO = new ArrayList<ChamadoVO>();
		chamadoVO = chamadoController.buscarChamadosController(usuarioVO, 0);
		System.out.println("\n================== Chamados ==================");
		if (chamadoVO != null) {
			for (int c = 0; c < chamadoVO.size(); c++) {
				System.out.println(chamadoVO.get(c).toString());
